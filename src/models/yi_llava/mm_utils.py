...
def __expand2square(pil_img, background_color):
...
def expand2square(pil_img, background_color):
    ...
    new_img = Image.new(pil_img.mode, (size, size), int(background_color[0]))  # 変更
    new_img.paste(pil_img, ((size - width) // 2, (size - height) // 2))
    return new_img
